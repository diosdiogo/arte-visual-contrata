      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">
            Transformamos suas{" "}
            <span className="text-primary animate-scale-in inline-block">ideias</span> em{" "}
            <span className="text-primary animate-scale-in inline-block">realidade digital</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Apps Personalizados</h3>
              <p className="text-gray-300">Soluções sob medida para sua empresa</p>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              <Palette className="h-12 w-12 text-primary mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-2 text-white">Design Profissional</h3>
